...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Reset.setGeometry(QRect(390, 15, 75, 24))
        self.pushButton_Reset.setCursor(QCursor(Qt.CursorShape.OpenHandCursor))
        ...
        self.pushButton_Add_New_Physiotherapist.setGeometry(QRect(200, 390, 81, 31))
        self.pushButton_Add_New_Physiotherapist.setCursor(QCursor(Qt.CursorShape.OpenHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_Add_New_Physiotherapist.setText(QCoreApplication.translate("MainWindow", u"Add Admin", None))
