...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if (self.tableWidget_Physiotherapists.columnCount() < 8):
            self.tableWidget_Physiotherapists.setColumnCount(8)
        ...
        self.tableWidget_Physiotherapists.setHorizontalHeaderItem(7, __qtablewidgetitem7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem7 = self.tableWidget_Physiotherapists.horizontalHeaderItem(7)
