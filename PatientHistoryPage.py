...
class Ui_PatientHistoryPage(object):
    def setupUi(self, PatientHistoryPage):
        if not PatientHistoryPage.objectName():
            PatientHistoryPage.setObjectName(u"PatientHistoryPage")
        PatientHistoryPage.resize(1522, 691)
        self.centralwidget = QWidget(PatientHistoryPage)
        ...
        self.label_Patient_History_Page.setGeometry(QRect(10, 20, 1501, 20))
        font = QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.label_To_Date.setGeometry(QRect(590, 560, 110, 16))
        ...
        self.label_From_Date.setGeometry(QRect(420, 560, 110, 16))
        ...
        PatientHistoryPage.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(PatientHistoryPage)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1522, 22))
        PatientHistoryPage.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(PatientHistoryPage)
        self.statusbar.setObjectName(u"statusbar")
        PatientHistoryPage.setStatusBar(self.statusbar)

        self.retranslateUi(PatientHistoryPage)

        self.comboBoxLanguage.setCurrentIndex(-1)


        QMetaObject.connectSlotsByName(PatientHistoryPage)
    # setupUi

    def retranslateUi(self, PatientHistoryPage):
        PatientHistoryPage.setWindowTitle(QCoreApplication.translate("PatientHistoryPage", u"Patient History Page", None))
        self.label_Patient_History_Page.setText(QCoreApplication.translate("PatientHistoryPage", u"Patient History Page", None))
        ___qtablewidgetitem = self.tableWidget_History.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("PatientHistoryPage", u"Test Date", None));
        ___qtablewidgetitem1 = self.tableWidget_History.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("PatientHistoryPage", u"Fall Risk", None));
        ___qtablewidgetitem2 = self.tableWidget_History.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("PatientHistoryPage", u"Total Steps", None));
        ___qtablewidgetitem3 = self.tableWidget_History.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("PatientHistoryPage", u"Error Steps", None));
        ___qtablewidgetitem4 = self.tableWidget_History.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("PatientHistoryPage", u"Start Time", None));
        ___qtablewidgetitem5 = self.tableWidget_History.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("PatientHistoryPage", u"End Time", None));
        ___qtablewidgetitem6 = self.tableWidget_History.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("PatientHistoryPage", u"Test Time (sec)", None));
        self.ExportToCSVButton.setText(QCoreApplication.translate("PatientHistoryPage", u"Export to CSV", None))
        self.NewTestButton.setText(QCoreApplication.translate("PatientHistoryPage", u"New Test", None))
        self.label_To_Date.setText(QCoreApplication.translate("PatientHistoryPage", u"To Date:", None))
        self.LogOffButton.setText(QCoreApplication.translate("PatientHistoryPage", u"Log Off", None))
        self.label_From_Date.setText(QCoreApplication.translate("PatientHistoryPage", u"From Date:", None))
        self.label_Gauge_Title.setText(QCoreApplication.translate("PatientHistoryPage", u"TextLabel", None))
        self.label_Gauge_Percentage.setText(QCoreApplication.translate("PatientHistoryPage", u"TextLabel", None))
        self.comboBoxLanguage.setItemText(0, QCoreApplication.translate("PatientHistoryPage", u"English", None))
        self.comboBoxLanguage.setItemText(1, QCoreApplication.translate("PatientHistoryPage", u"\u05e2\u05d1\u05e8\u05d9\u05ea", None))
