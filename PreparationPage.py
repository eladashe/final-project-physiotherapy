...
class Ui_PreparationPage(object):
    def setupUi(self, PreparationPage):
        if not PreparationPage.objectName():
            PreparationPage.setObjectName(u"PreparationPage")
        PreparationPage.resize(661, 349)
        self.centralwidget = QWidget(PreparationPage)
        ...
        self.label_Title.setGeometry(QRect(20, 10, 621, 41))
        font1 = QFont()
        ...
        self.comboBoxLanguage.setGeometry(QRect(580, 20, 68, 22))
        self.comboBoxLanguage.setCursor(QCursor(Qt.CursorShape.OpenHandCursor))
        PreparationPage.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(PreparationPage)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 661, 22))
        PreparationPage.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(PreparationPage)
        self.statusbar.setObjectName(u"statusbar")
        PreparationPage.setStatusBar(self.statusbar)

        self.retranslateUi(PreparationPage)

        self.comboBoxLanguage.setCurrentIndex(-1)


        QMetaObject.connectSlotsByName(PreparationPage)
    # setupUi

    def retranslateUi(self, PreparationPage):
        PreparationPage.setWindowTitle(QCoreApplication.translate("PreparationPage", u"Preparation Page", None))
        self.label_Instructions.setText(QCoreApplication.translate("PreparationPage", u"Please prepare the patient for the test according to the following instructions:\n"
"\n"
...
"When everything is ready, click \"Start Test\" to proceed.", None))
        self.label_Title.setText(QCoreApplication.translate("PreparationPage", u"Instructions before starting the test:", None))
        self.StartTestButton.setText(QCoreApplication.translate("PreparationPage", u"Start Test", None))
        self.comboBoxLanguage.setItemText(0, QCoreApplication.translate("PreparationPage", u"English", None))
        self.comboBoxLanguage.setItemText(1, QCoreApplication.translate("PreparationPage", u"\u05e2\u05d1\u05e8\u05d9\u05ea", None))
