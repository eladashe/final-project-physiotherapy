...
class Ui_RemoveExistingPhysiotherapists(object):
    def setupUi(self, RemoveExistingPhysiotherapists):
        if not RemoveExistingPhysiotherapists.objectName():
            RemoveExistingPhysiotherapists.setObjectName(u"RemoveExistingPhysiotherapists")
        RemoveExistingPhysiotherapists.resize(850, 523)
        self.centralwidget = QWidget(RemoveExistingPhysiotherapists)
        self.centralwidget.setObjectName(u"centralwidget")
        self.label_Remove_Existing_Physiotherapist = QLabel(self.centralwidget)
        self.label_Remove_Existing_Physiotherapist.setObjectName(u"label_Remove_Existing_Physiotherapist")
        self.label_Remove_Existing_Physiotherapist.setGeometry(QRect(25, 10, 811, 41))
        font = QFont()
        font.setPointSize(9)
        font.setBold(True)
        self.label_Remove_Existing_Physiotherapist.setFont(font)
        ...
        RemoveExistingPhysiotherapists.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(RemoveExistingPhysiotherapists)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 850, 22))
        RemoveExistingPhysiotherapists.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(RemoveExistingPhysiotherapists)
        self.statusbar.setObjectName(u"statusbar")
        RemoveExistingPhysiotherapists.setStatusBar(self.statusbar)
        ...
        self.retranslateUi(RemoveExistingPhysiotherapists)

        self.comboBoxLanguage.setCurrentIndex(-1)


        QMetaObject.connectSlotsByName(RemoveExistingPhysiotherapists)
    # setupUi

    def retranslateUi(self, RemoveExistingPhysiotherapists):
        RemoveExistingPhysiotherapists.setWindowTitle(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Remove Existing Physiotherapist", None))
        self.label_Remove_Existing_Physiotherapist.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Remove Existing Physiotherapist", None))
        self.RemoveButton.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Remove Existing Physiotherapist", None))
        self.ReturnButton.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Return", None))
        self.LogOffButton.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Log Off", None))
        ___qtablewidgetitem = self.tableWidget_Physiotherapists.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Email", None));
        ___qtablewidgetitem1 = self.tableWidget_Physiotherapists.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Username", None));
        ___qtablewidgetitem2 = self.tableWidget_Physiotherapists.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"First Name", None));
        ___qtablewidgetitem3 = self.tableWidget_Physiotherapists.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Last Name", None));
        ___qtablewidgetitem4 = self.tableWidget_Physiotherapists.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Gender", None));
        ___qtablewidgetitem5 = self.tableWidget_Physiotherapists.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Age", None));
        ___qtablewidgetitem6 = self.tableWidget_Physiotherapists.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("RemoveExistingPhysiotherapists", u"Is Admin", None));
        self.comboBoxLanguage.setItemText(0, QCoreApplication.translate("RemoveExistingPhysiotherapists", u"English", None))
        self.comboBoxLanguage.setItemText(1, QCoreApplication.translate("RemoveExistingPhysiotherapists", u"\u05e2\u05d1\u05e8\u05d9\u05ea", None))
