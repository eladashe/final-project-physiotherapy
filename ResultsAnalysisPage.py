...
class Ui_ResultsAnalysisPage(object):
    def setupUi(self, ResultsAnalysisPage):
        if not ResultsAnalysisPage.objectName():
            ResultsAnalysisPage.setObjectName(u"ResultsAnalysisPage")
        ResultsAnalysisPage.resize(432, 441)
        self.centralwidget = QWidget(ResultsAnalysisPage)
        ...
        self.tableWidget_Results.setGeometry(QRect(20, 80, 392, 221))
        ...
        self.label_Result_Page.setGeometry(QRect(20, 20, 392, 22))
        font3 = QFont()
        ...
        self.comboBoxLanguage.setGeometry(QRect(344, 20, 68, 22))
        self.comboBoxLanguage.setCursor(QCursor(Qt.CursorShape.OpenHandCursor))
        ResultsAnalysisPage.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(ResultsAnalysisPage)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 432, 22))
        ResultsAnalysisPage.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(ResultsAnalysisPage)
        self.statusbar.setObjectName(u"statusbar")
        ResultsAnalysisPage.setStatusBar(self.statusbar)
        ...
        self.retranslateUi(ResultsAnalysisPage)

        self.comboBoxLanguage.setCurrentIndex(-1)


        QMetaObject.connectSlotsByName(ResultsAnalysisPage)
    # setupUi

    def retranslateUi(self, ResultsAnalysisPage):
        ResultsAnalysisPage.setWindowTitle(QCoreApplication.translate("ResultsAnalysisPage", u"Result Analysis Page", None))
        ___qtablewidgetitem = self.tableWidget_Results.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Value", None));
        ___qtablewidgetitem1 = self.tableWidget_Results.verticalHeaderItem(0)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Fall Risk", None));
        ___qtablewidgetitem2 = self.tableWidget_Results.verticalHeaderItem(1)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Test Time", None));
        ___qtablewidgetitem3 = self.tableWidget_Results.verticalHeaderItem(2)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Number of Steps", None));
        ___qtablewidgetitem4 = self.tableWidget_Results.verticalHeaderItem(3)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Error Steps", None));
        ...
        self.label_Result_Page.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Result Analysis Page", None))
        self.HistoryResultsButton.setText(QCoreApplication.translate("ResultsAnalysisPage", u"History Results", None))
        self.NewTestButton.setText(QCoreApplication.translate("ResultsAnalysisPage", u"New Test", None))
        self.LogOffButton.setText(QCoreApplication.translate("ResultsAnalysisPage", u"Log Off", None))
        self.comboBoxLanguage.setItemText(0, QCoreApplication.translate("ResultsAnalysisPage", u"English", None))
        self.comboBoxLanguage.setItemText(1, QCoreApplication.translate("ResultsAnalysisPage", u"\u05e2\u05d1\u05e8\u05d9\u05ea", None))
